...
import { Container, Row, Col } from 'react-bootstrap'; // เพิ่ม Row, Col
...
const AllCompetitions = () => {
  ...
  const filteredContests = contests.filter(contest => {
    ...
    // หมายเหตุ: การกรองตรงนี้ยังใช้ field เดิมจาก DB (topic_type/poetry_type) 
    // ถ้าต้องการกรองละเอียดกว่านี้อาจต้องปรับ logic เหมือนตอนแสดงผล
      ...
      <div style={{ flex: 1, transition: '0.3s' }}>
        ...
        <div className="activities-container" style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 24px' }}>
          ...
          {loading ? (
            ...
            // ใช้ Row/Col แบบเดียวกับ ActivitiesList เพื่อความสวยงาม
            <Row xs={1} md={2} lg={4} className="g-4 mt-3">
              {filteredContests.length > 0 ? (
                filteredContests.map(contest => {
                  ...
                  // --- Logic การดึงข้อมูลแบบเจาะลึก (เหมือน ActivitiesList) ---
                      ...
                      >
                        <div className="custom-card">
                          ...
                          <div className="card-content">
                            ...
                            {/* ORGANIZATION NAME (เพิ่มส่วนนี้) */}
                            {org && (
