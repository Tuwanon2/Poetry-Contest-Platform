...
const Home = () => {
  ...
  <span className="elgy-tooltip4">
    ...
    >
      <path
        d="M13.545 2.907a13.2 13.2 0 0 0-3.257-1.011.05.05 0 0 0-.052.025c-.141.25-.297.577-.406.833a12.2 12.2 0 0 0-3.658 0 8 8 0 0 0-.412-.833.05.05 0 0 0-.052-.025c-1.125.194-2.22.534-3.257 1.011a.04.04 0 0 0-.021.018C.356 6.024-.213 9.047.066 12.032q.003.022.021.037a13.3 13.3 0 0 0 3.995 2.02.05.05 0 0 0 .056-.019q.463-.63.818-1.329a.05.05 0 0 0-.01-.059l-.018-.011a9 9 0 0 1-1.248-.595.05.05 0 0 1-.02-.066l.015-.019q.127-.095.248-.195a.05.05 0 0 1 .051-.007c2.618 1.196 5.454 1.196 8.041 0a.05.05 0 0 1 .052.007q.121.1.248.195a.05.05 0 0 1-.004.085 7.775 7.775 0 0 1-1.249.594.05.05 0 0 0-.03.03q.358.703.818 1.329a.05.05 0 0 0 .056.02 13.235 13.235 0 0 0 4.001-2.02.05.05 0 0 0 .02-.037c.334-3.42-.559-6.404-2.36-9.107a.034.034 0 0 0-.02-.018zM5.785 10.668c-.789 0-1.438-.724-1.438-1.612s.634-1.614 1.438-1.614c.806 0 1.454.735 1.438 1.614 0 .888-.634 1.612-1.438 1.612zm4.392 0c-.79 0-1.438-.724-1.438-1.612s.633-1.614 1.438-1.614c.805 0 1.454.735 1.438 1.614 0 .888-.634 1.612-1.438 1.612z"
      ></path>
    </svg>
  </span>
</div>
